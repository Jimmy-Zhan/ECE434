...
eQEP1 = '1'
eQEP2 = '2'
COUNTPATH1 = '/sys/bus/counter/devices/counter'+eQEP1+'/count0'
COUNTPATH2 = '/sys/bus/counter/devices/counter'+eQEP2+'/count0'
ms = 100
maxCount = 1000000
...
#        print(data1)
 #       print(data2)
        if int(data1) > olddata1 and current_y > 0:
            current_y -= 1
        elif int(data1) < olddata1   and current_y < size - 1:
            current_y += 1
        elif int(data2)>olddata2  and current_x > 0:
            current_x -= 1
        elif int(data2)<olddata2  and current_x < size - 1:
            current_x += 1
